...
var commonInvalidClassroomsAndCorrections= [
    {invalidClassroom: "61号館2階", newLocation: "61-2F", newBuilding:"61", newClassroom:"2F" },
    {invalidClassroom: "61号館BF", newLocation: "61-BF", newBuilding:"61", newClassroom:"BF" },
    {invalidClassroom: "Business Design & Management labo 61-2F", newLocation: "61-2F Business Design & Management lab", newBuilding:"61", newClassroom:"2F Business Design & Management lab" },
    {invalidClassroom: "foyer 50-301", newLocation: "50-301", newBuilding:"50", newClassroom:"301" },
    {invalidClassroom: "Seminar room 3 50-304", newLocation: "50-304", newBuilding:"50", newClassroom:"304" }
];

//Find and correct invalid classroom field embedded in an array of course documents ONE BY ONE
...
//Export distinct courses by grouping multiple schools
...
//Group and export classroom schedules by weekdays and sort by building number and name
classroomsSciEngWeekdays.forEach(function (object) {
    db.getCollection(classroomsSciEng).aggregate([
        ...
        { $group: {_id: "$_id", name: {$first :"$name"}, building: {$first: "$building"}, courses: { $push :"$courses"  } } },
        { $sort: { building: 1, name: 1} },
